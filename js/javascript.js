//BASE DE DATOS
	var productos = ["Café  en polvo San José", "Café en grano San Jose" ];
	var imgGrandes = ["img/coffee-coffee-maker-restaurant-cafe-52977.jpg", "img/coffee-coffee-maker-restaurant-cafe-52977.jpg","img/coffee-coffee-maker-restaurant-cafe-52977.jpg"];
	var imgPeque = [  "img/coffee-coffee-maker-restaurant-cafe-52977.jpg","img/restaurant-beans-coffee-morning.jpg"];
	
	var precios = [75, 120, 155 ];
	var stock = [300, 300,300];
	var precioTransporte = [ "gratis"];
	var IVA = 0.15;
	var uniUser;
...
/**/			document.getElementById("divPago").className = "divsNo";				
		...
		document.getElementById("tablaTotal").innerHTML = tablaTotal + '<tr><td>&nbsp;</td>&nbsp;<td></td><td class="preUni"><b>Transporte: </b></td><td class="preTotal"><b>' +totalTransporte+ '</b></td></tr>' + '<tr><td>&nbsp;</td>&nbsp;<td></td><td class="preUni"><b>IVA ('+(IVA*100)+'%): </b></td><td class="preTotal"><b>' +totalIVA+ '</b></td></tr>' + '<tr><td>&nbsp;</td>&nbsp;<td></td><td class="preUni"><b>Total: </b></td><td class="preTotal" id="totalAPagar"><b>' +totalAPagar+ ' L.</b></td></tr>';
	}	
